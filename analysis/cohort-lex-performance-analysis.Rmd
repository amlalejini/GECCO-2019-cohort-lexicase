...
paper_plot_data <- filter(prog_solutions_evals_summary, test_mode=="SEL_COHORT_LEX" & evaluation=="78643200")
plt<-ggplot(data = paper_plot_data, mapping=aes(x=cohort_config, y=solutions_found, fill=cohort_config)) +
      ...
      ggsave("fixed-evals-performance-late.pdf", height=5, width=15)
plt
```
