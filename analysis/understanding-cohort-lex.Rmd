...
```{r}
ggplot(data = filter(prog_solutions_evals_summary, cohort_config=="cn2:cs256" & evaluation=="78643200"), mapping=aes(x=test_mode, y=solutions_found, fill=test_mode)) +
...
```{r}
ggplot(data = filter(prog_solutions_evals_summary, cohort_config=="cn4:cs128" & evaluation=="78643200"), mapping=aes(x=test_mode, y=solutions_found, fill=test_mode)) +
    geom_bar(stat="identity") + xlab("Selection Scheme") + ylab("Successful Runs")  +  ylim(0, 52) +
    guides(fill=FALSE)+
    geom_text(aes(label=solutions_found), nudge_y=3) + 
    theme(axis.title.x = element_text(size=12)) + 
...
```{r}
ggplot(data = filter(prog_solutions_evals_summary, cohort_config=="cn16:cs32" & evaluation=="78643200"), mapping=aes(x=test_mode, y=solutions_found, fill=test_mode)) +
    geom_bar(stat="identity") + xlab("Selection Scheme") + ylab("Successful Runs")  +  ylim(0, 52) +
    guides(fill=FALSE)+
    geom_text(aes(label=solutions_found), nudge_y=3) + 
    theme(axis.title.x = element_text(size=12)) + 
...
```{r}
ggplot(data = filter(prog_solutions_evals_summary, cohort_config=="cn32:cs16" & evaluation=="78643200"), mapping=aes(x=test_mode, y=solutions_found, fill=test_mode)) +
    geom_bar(stat="identity") + xlab("Selection Scheme") + ylab("Successful Runs")  +  ylim(0, 52) +
    guides(fill=FALSE)+
    geom_text(aes(label=solutions_found), nudge_y=3) + 
    theme(axis.title.x = element_text(size=12)) + 
...
```{r}
ggplot(data = filter(prog_solutions_evals_summary, cohort_config=="cn64:cs8" & evaluation=="78643200"), mapping=aes(x=test_mode, y=solutions_found, fill=test_mode)) +
    geom_bar(stat="identity") + xlab("Selection Scheme") + ylab("Successful Runs")  +  ylim(0, 52) +
    guides(fill=FALSE)+
    geom_text(aes(label=solutions_found), nudge_y=3) + 
    theme(axis.title.x = element_text(size=12)) + 
...
```{r}
ggplot(data = filter(prog_solutions_evals_summary, cohort_config=="cn128:cs4" & evaluation=="78643200"), mapping=aes(x=test_mode, y=solutions_found, fill=test_mode)) +
    geom_bar(stat="identity") + xlab("Selection Scheme") + ylab("Successful Runs")  +  ylim(0, 52) +
    guides(fill=FALSE)+
    geom_text(aes(label=solutions_found), nudge_y=3) + 
    theme(axis.title.x = element_text(size=12)) + 
...
```{r}
ggplot(data = filter(prog_solutions_evals_summary, cohort_config=="cn256:cs2" & evaluation=="78643200"), mapping=aes(x=test_mode, y=solutions_found, fill=test_mode)) +
    geom_bar(stat="identity") + xlab("Selection Scheme") + ylab("Successful Runs")  +  ylim(0, 52) +
    guides(fill=FALSE)+
    geom_text(aes(label=solutions_found), nudge_y=3) + 
    theme(axis.title.x = element_text(size=12)) + 
